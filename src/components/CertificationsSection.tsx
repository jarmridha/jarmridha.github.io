...
const certs: Certificate[] = [
  { title: "Project Management Training: Unit 3", image: certPmpUnit3, pdf: "/certificates/pmp-unit-3.pdf", issuer: "Pearson · Coursera", date: "28 Aug 2025" },
